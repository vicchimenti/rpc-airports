...
xdr_airport_place (XDR *xdrs, airport_place *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_pointer (xdrs, (char **)objp, sizeof (struct airport_place_node), (xdrproc_t) xdr_airport_place_node))
		 return FALSE;
	return TRUE;
}

bool_t
xdr_airport_place_code (XDR *xdrs, airport_place_code objp)
{
	register int32_t *buf;
...
bool_t
xdr_city_place_name (XDR *xdrs, city_place_name objp)
{
	register int32_t *buf;
...
bool_t
xdr_state_place_initials (XDR *xdrs, state_place_initials objp)
{
	register int32_t *buf;
...
bool_t
xdr_airport_place_node (XDR *xdrs, airport_place_node *objp)
{
	register int32_t *buf;

	 if (!xdr_airport_place_code (xdrs, objp->airport_place))
		 return FALSE;
	 if (!xdr_city_place_name (xdrs, objp->city))
		 return FALSE;
	 if (!xdr_state_place_initials (xdrs, objp->state))
		 return FALSE;
	 if (!xdr_double (xdrs, &objp->distance))
		 return FALSE;
	 if (!xdr_airport_place (xdrs, &objp->next))
		 return FALSE;
	return TRUE;
}
